...
function loadStatsPage(){
	...
	for(i = 2; i < tableLength; i++){
		var buffsScore = parseInt(table.rows[i].cells[2].innerHTML);
		var otherScore = parseInt(table.rows[i].cells[3].innerHTML);
		if(buffsScore > otherScore){ //win
			table.rows[i].cells[4].innerHTML = "Colorado";
			wins++;
		}else if(buffsScore < otherScore){ //loss
...
function switchPlayers(playerNum){
	var found = false;
	var i = playerNum;
	var var_gamesPlayed = players[i].games_played;
	...
	document.getElementById("avg_p_yards").innerHTML = players[i].pass_yards/var_gamesPlayed;
	document.getElementById("avg_r_yards").innerHTML = players[i].rushing_yards/var_gamesPlayed;
	document.getElementById("avg_rec_yards").innerHTML = players[i].receiving_yards/var_gamesPlayed;
}
